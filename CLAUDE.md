...
1. **밸런스 시뮬레이터 후속** — 2026-07-19 봇 교착 3종 해소 + 새 콘텐츠 재실측 완료. 실측(16종 풀·방 이벤트 거절 조건): **하드런 사망 6·6·9·9·10·10층(평균 8.3)** — 기존 기준선과 같은 구간 / **파밍런(2층마다 전설) 10층 보스 사망 3/6·11층 2/6·31층+ 생존 1/6(80아이템)**. 잔여: 파밍런 스노볼 검토(보스만 넘기면 아이템 복리로 사실상 무적 — 상자 밀도·전설 확률로 제어 가능), 20·30층 보스 표본 확보. 교착 진단은 stuck 기록 시 localStorage `d100sim-stalltrace`(60초+ 체류 샘플) 참조. 숨김 탭 장시간 세션은 환경이 열화되니 **보이는 탭에서 돌리는 게 안정적**.
