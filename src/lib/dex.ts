...
// '발견의 광맥' — 런 밖에서 쌓이는 장기 수집 후크. 저장: localStorage `d100-dex`.
...
export const DEX_EVENTS: DexEntry[] = [
  ...
  { id: 'collapse', icon: '📚', name: '무너지는 서가', desc: '금박 표지를 빼내면 이 장(章)이 무너진다. 출구까지 달려라.' },
  { id: 'cave', icon: '🕳️', name: '깎여 나간 장', desc: '방도 복도도 없이 파먹힌 층 — 책이 아니라 굴에 가깝다.' },
