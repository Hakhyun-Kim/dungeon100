...
- **두 문 달리기 (자매작 크로스오버)**: 보물상자에 닿으면 자매작 [두 문 러너](https://hakhyun-kim.github.io/door-runner/)가 미니게임으로 등장 — 트랙을 달리며 정답이 적힌 문을 몸으로 통과해야만 아이템을 얻습니다. 문을 통과할 때마다 "더 달릴까?"를 선택하는 푸시-유어-럭 구조로, 3연속 문을 완주하면 전설의 보물을 얻습니다.
